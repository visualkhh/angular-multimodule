...
import com.lgu.cbcf.ecc.ans.PwsCancelRequest;
...
public class AnsCancelRequest {
    public static void main(String[] args) throws IOException {

        //DB SEND CELL
        // split 한뒤 0 뒤에 다붙혀줌
        PwsCancelRequest message = new PwsCancelRequest(4372, 1);
        message.makeSapWriteReplace();
